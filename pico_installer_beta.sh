...
if [ -f pico_menu_option.conf ]; then
menu_option=`cat pico_menu_option.conf | grep menu_option`	
if [ "$menu_option" != "menu_option=0" ] ; then	
sed -i "s,$menu_option,menu_option=0," pico_menu_option.conf
fi
else
echo menu_option=0 >> pico_menu_option.conf
fi
		...
		do
			case $opt in
				"Install - PIco HV3.0A")
					...
					sed -i "s,$menu_option,menu_option=1," pico_menu_option.conf
					fi		
					break			
					;;
				"remove - PIco HV3.0A")
					...
					sed -i "s,$menu_option,menu_option=2," pico_menu_option.conf
					fi	
					break			
					;;
				"Status - PIco HV3.0A")
					...
					sed -i "s,$menu_option,menu_option=3," pico_menu_option.conf
					fi	
					break			
					;;						
				"Quit")
					...
					sed -i "s,$menu_option,menu_option=4," pico_menu_option.conf
					fi
					break
					;;
				*) echo invalid option;;
